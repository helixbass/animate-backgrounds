...
(function() {
  var Color, Tween, _int, angle_from_direction, angle_or_direction_regex_chunk, color_eq, color_regex_chunk, extend, extended, gradient_handler, index_regex_chunk, is_string, length_regex_chunk, map, parse_linear_gradient, parse_radial_gradient, pre_stops_css_linear_gradient, pre_stops_css_radial_gradient, regex_chunk_str, register_animation_handler, scaled, value_regex_chunk,
    slice = [].slice;
    ...
    return {
      ...
      init_tween_end: function(arg1) {
        ...
        changing_vals = (function() {
          var all, angle, color, first_direction, index, indexed_parsed_pairs, match, pair, parsed_pairs, position, remaining, second_direction, second_position, second_unit, separator, set_from_match_params, unit;
          parsed_pairs = [];
          ...
          while (remaining) {
            ...
            all = match[0], angle = match[1], first_direction = match[2], second_direction = match[3], position = match[4], unit = match[5], color = match[6], second_position = match[7], second_unit = match[8];
            pair = {
              type: (function() {
                switch (false) {
                  case color == null:
            ...
            set_from_match_params = function(start_or_end) {
            ...
            all = match[0], angle = match[1], first_direction = match[2], second_direction = match[3], position = match[4], unit = match[5], color = match[6], second_position = match[7], second_unit = match[8], separator = match[9];
  ...
  register_animation_handler(gradient_handler({
    detect_gradient_type: function(image) {
